...
liloth_database = start_engine()


async def run_query(raw_query, return_value=False, batch=False, params=None):
    return await liloth_database.run_session_query(raw_query, return_value=return_value, batch=batch, params=params)


async def close_database_session():
    liloth_database.close_session()